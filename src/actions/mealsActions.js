...
export const startFetchMealsBySearch = async(dispatch, searchTerm) => {
    ...
    try{
        ...
        if(error && searchTerm!="water" && searchTerm!="salt" &&searchTerm!="flour"&&searchTerm!="flour salt"&&searchTerm!="flour salt water"&&searchTerm!="flour water"&&searchTerm!="salt water"&&searchTerm!="water salt"&&searchTerm!="water flour"){
